...
class Runner(object):
    """
    Wrapper class used for running multiple experiments for varying parameter settings.
    Stores the final city grids as results.
    """
    def __init__(self, args, iterations=500):
        self.args = args
    ...
    def run_experiment(self):
        # Runs experiment for given # of iterations. Uses all available cores minus 1 for quick computation times.
    ...
    def clean_memory(self):
        # Clears object from memory and collects garbage.
        # Used because memory errors occured when computing high number of experiments.
        del self
        gc.collect()
